...
import { ArrowRight, Info, Building2 } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <section className="text-center mb-16">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <Link href="/partner-info" className="btn-secondary flex items-center gap-2 border-2 border-accent-500 text-accent-700 hover:bg-accent-50">
              <Building2 size={20} />
              Per Hotel Partner
            </Link>
          </div>
